...
- (void)beforeEncode
{
    ...
    {
        [_var_supported_monitoring_events beforeEncode];
...
+ (id)definition
{
    ...
    avpDef[@"name"] = @"supported-services";
    avpDef[@"type"] = @"Grouped";
    ...
    {
        UMSynchronizedSortedDictionary *def =  [UMDiameterAvpSupported_Monitoring_Events definition];
        def[@"multiple"]=@(NO);
        def[@"mandatory"]=@(NO);
