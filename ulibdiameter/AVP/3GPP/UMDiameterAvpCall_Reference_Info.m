...
- (void)afterDecode
{
    ...
    {
        if(avp.avpCode == [UMDiameterAvpCall_Reference_Number  avpCode])
        {
            _var_call_reference_number = [[UMDiameterAvpCall_Reference_Number alloc]initWithAvp:avp];
            [knownAVPs addObject:_var_call_reference_number];
        }
        else if(avp.avpCode == [UMDiameterAvpAS_Number avpCode])
        {
            _var_as_number = [[UMDiameterAvpAS_Number alloc]initWithAvp:avp];
            [knownAVPs addObject:_var_as_number];
        }
        else
        {
             if(unknownAVPs==NULL)
