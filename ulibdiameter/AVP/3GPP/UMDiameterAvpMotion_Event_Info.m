...
- (void)afterDecode
{
    ...
    {
        if(avp.avpCode == [UMDiameterAvpLinear_Distance  avpCode])
        {
            _var_linear_distance = [[UMDiameterAvpLinear_Distance alloc]initWithAvp:avp];
            [knownAVPs addObject:_var_linear_distance];
        }
