...
//  ulibdiameter
//
//  Created by afink on 2019-07-01 20:38:41.622000
...
- (UMDiameterPacketAuthentication_Information_Answer *)initWithString:(NSString *)s
{
    self = [super init];
    if(self)
    {
...
- (void)beforeEncode
{
    ...
    if(_authentication_info)
    {
        [arr addObject:_authentication_info]
    }
    if(_ue_usage_type)
    {
