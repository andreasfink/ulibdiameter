...
@interface UMDiameterPacketInsert_Subscriber_Data_Answer : UMDiameterPacket
{
	...
	UMDiameterAvpIMS_Voice_Over_PS_Sessions_Supported	*_ims_voice_over_ps_sessions_supported;
	UMDiameterAvpLast_UE_Activity_Time	*_last_ue_activity_time;
	UMDiameterAvpRAT_Type	*_rat_type;
	UMDiameterAvpIDA_Flags	*_ida_flags;
	UMDiameterAvpEPS_User_State	*_eps_user_state;
	UMDiameterAvpEPS_Location_Information	*_eps_location_information;
	UMDiameterAvpLocal_Time_Zone	*_local_time_zone;
	UMDiameterAvpSupported_Services	*_supported_services;
	NSArray<UMDiameterAvpMonitoring_Event_Report *>	*_monitoring_event_report;
	NSArray<UMDiameterAvpMonitoring_Event_Config_Status *>	*_monitoring_event_config_status;
