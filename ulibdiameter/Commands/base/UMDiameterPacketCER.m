...
//  ulibdiameter
//
//  Created by afink on 2021-03-23 23:12:19.821107
...
- (void)afterDecode
{
    ...
    for(UMDiameterAvp *avp in _packet_avps)
    {
        ...
        else if(avp.avpCode == [UMDiameterAvpInband_Security_Id avpCode])
        {
            UMDiameterAvpInband_Security_Id *avp2 = [[UMDiameterAvpInband_Security_Id alloc]initWithAvp:avp];
