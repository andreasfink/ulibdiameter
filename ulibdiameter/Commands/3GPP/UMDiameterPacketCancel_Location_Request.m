...
//  ulibdiameter
//
//  Created by afink on 2019-07-10 00:07:33.103000
...
+ (void)webDiameterParameters:(NSMutableString *)s
{
    ...
    [s appendString:@"<tr>\n"];
    [s appendString:@"    <td class=mandatory>cancellation-type</td>\n"];
    [s appendString:@"    <td class=mandatory><input name=\"cancellation-type\" type=text> </td>\n"];
    [s appendString:@"</tr>\n"];

    [s appendString:@"<tr>\n"];
    [s appendString:@"    <td class=optional>clr-flags</td>\n"];
    [s appendString:@"    <td class=optional><input name=\"clr-flags\" type=text> </td>\n"];
    [s appendString:@"</tr>\n"];
