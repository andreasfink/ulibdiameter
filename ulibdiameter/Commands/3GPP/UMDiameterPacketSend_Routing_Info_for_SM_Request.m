...
//  ulibdiameter
//
//  Created by afink on 2021-03-23 23:12:21.244094
//  Copyright © 2019 Andreas Fink. All rights reserved.
//


#import <ulibdiameter/UMDiameterPacketSend_Routing_Info_for_SM_Request.h>
...
- (void)afterDecode
{
    ...
    for(UMDiameterAvp *avp in _packet_avps)
    {
        ...
        else if(avp.avpCode == [UMDiameterAvpSM_RP_MTI avpCode])
        {
        ...
        else if(avp.avpCode == [UMDiameterAvpSRR_Flags avpCode])
        {
            UMDiameterAvpSRR_Flags *avp2 = [[UMDiameterAvpSRR_Flags alloc]initWithAvp:avp];
            _var_srr_flags = avp2;
        }
        else if(avp.avpCode == [UMDiameterAvpSM_Delivery_Not_Intended avpCode])
        {
