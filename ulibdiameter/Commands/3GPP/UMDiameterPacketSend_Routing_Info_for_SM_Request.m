...
//  ulibdiameter
//
//  Created by afink on 2021-03-22 08:41:00.508643
...
- (void)afterDecode
{
    for(UMDiameterAvp *avp in _packet_avps)
    {
        ...
        {
                UMDiameterAvp *avp2 = [[UMDiameterAvpSM_RP_MTI alloc]initWithAvp:avp];
            _var_sm_rp_mti = avp2;
            [knownAVPs addObject:avp2]
        }
        if(avp.avpCode == [UMDiameterAvpSM_RP_SMEA avpCode])
        {
                UMDiameterAvp *avp2 = [[UMDiameterAvpSM_RP_SMEA alloc]initWithAvp:avp];
            _var_sm_rp_smea = avp2;
            [knownAVPs addObject:avp2]
        }
        if(avp.avpCode == [UMDiameterAvpSRR_Flags avpCode])
        {
                UMDiameterAvp *avp2 = [[UMDiameterAvpSRR_Flags alloc]initWithAvp:avp];
            _var_srr_flags = avp2;
            [knownAVPs addObject:avp2]
        }
        if(avp.avpCode == [UMDiameterAvpSM_Delivery_Not_Intended avpCode])
        {
                UMDiameterAvp *avp2 = [[UMDiameterAvpSM_Delivery_Not_Intended alloc]initWithAvp:avp];
