...
//  ulibdiameter
//
//  Created by afink on 2019-07-10 00:07:33.043000
...
+ (void)webDiameterParameters:(NSMutableString *)s
{
    ...
    [s appendString:@"<tr>\n"];
    [s appendString:@"    <td class=optional>ims-voice-over-ps-sessions-supported</td>\n"];
    [s appendString:@"    <td class=optional><input name=\"ims-voice-over-ps-sessions-supported\" type=text> </td>\n"];
    [s appendString:@"</tr>\n"];

    [s appendString:@"<tr>\n"];
    [s appendString:@"    <td class=optional>last-ue-activity-time</td>\n"];
    [s appendString:@"    <td class=optional><input name=\"last-ue-activity-time\" type=text> </td>\n"];
    [s appendString:@"</tr>\n"];

    [s appendString:@"<tr>\n"];
    [s appendString:@"    <td class=optional>rat-type</td>\n"];
    [s appendString:@"    <td class=optional><input name=\"rat-type\" type=text> </td>\n"];
    [s appendString:@"</tr>\n"];

    [s appendString:@"<tr>\n"];
    [s appendString:@"    <td class=optional>ida-flags</td>\n"];
    [s appendString:@"    <td class=optional><input name=\"ida-flags\" type=text> </td>\n"];
    [s appendString:@"</tr>\n"];

    [s appendString:@"<tr>\n"];
    [s appendString:@"    <td class=optional>eps-user-state</td>\n"];
    [s appendString:@"    <td class=optional><input name=\"eps-user-state\" type=text> </td>\n"];
    [s appendString:@"</tr>\n"];

    [s appendString:@"<tr>\n"];
    [s appendString:@"    <td class=optional>eps-location-information</td>\n"];
    [s appendString:@"    <td class=optional><input name=\"eps-location-information\" type=text> </td>\n"];
    [s appendString:@"</tr>\n"];

    [s appendString:@"<tr>\n"];
    [s appendString:@"    <td class=optional>local-time-zone</td>\n"];
    [s appendString:@"    <td class=optional><input name=\"local-time-zone\" type=text> </td>\n"];
    [s appendString:@"</tr>\n"];
    ...
    [s appendString:@"<tr>\n"];
    [s appendString:@"    <td class=optional>monitoring-event-report</td>\n"];
    [s appendString:@"    <td class=optional><input name=\"monitoring-event-report\" type=text> </td>\n"];
    [s appendString:@"</tr>\n"];
