...
//  ulibdiameter
//
//  Created by afink on 2021-03-22 08:41:00.406342
...
- (void)afterDecode
{
    for(UMDiameterAvp *avp in _packet_avps)
    {
        ...
        if(avp.avpCode == [UMDiameterAvpRepository_Data_ID avpCode])
        {
                UMDiameterAvp *avp2 = [[UMDiameterAvpRepository_Data_ID alloc]initWithAvp:avp];
        ...
        if(avp.avpCode == [UMDiameterAvpOC_OLR avpCode])
        {
                UMDiameterAvp *avp2 = [[UMDiameterAvpOC_OLR alloc]initWithAvp:avp];
            _var_oc_olr = avp2;
            [knownAVPs addObject:avp2]
        }
        if(avp.avpCode == [UMDiameterAvpLoad avpCode])
        {
                UMDiameterAvp *avp2 = [[UMDiameterAvpLoad alloc]initWithAvp:avp];
            if(_var_load == NULL)
            {
