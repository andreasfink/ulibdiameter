...
//  ulibdiameter
//
//  Created by afink on 2019-10-16 21:45:27.269000
...
- (void)afterDecode
{
    for(UMDiameterAvp *avp in _packet_avps)
    {
        ...
        else if([avp isKindOfClass:[UMDiameterAvpRepository_Data_ID class]])
        {
            _var_repository_data_id = (UMDiameterAvpRepository_Data_ID *)avp;
        }
        else if([avp isKindOfClass:[UMDiameterAvpData_Reference class]])
        {
            _var_data_reference = (UMDiameterAvpData_Reference *)avp;
        }
...
+ (NSString *)webJsonDefintion
{
    ...
    [arr addObject: [UMDiameterAvpRepository_Data_ID definition]];
    ...
    [arr addObject: [UMDiameterAvpOC_OLR definition]];
    [arr addObject: [UMDiameterAvpLoad definition]];
