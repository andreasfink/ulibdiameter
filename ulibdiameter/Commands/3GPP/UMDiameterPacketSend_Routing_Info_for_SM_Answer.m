...
//  ulibdiameter
//
//  Created by afink on 2021-03-22 08:41:00.541998
...
- (void)afterDecode
{
    for(UMDiameterAvp *avp in _packet_avps)
    {
        ...
        if(avp.avpCode == [UMDiameterAvpAdditional_Serving_Node avpCode])
        {
                UMDiameterAvp *avp2 = [[UMDiameterAvpAdditional_Serving_Node alloc]initWithAvp:avp];
            _var_additional_serving_node = avp2;
            [knownAVPs addObject:avp2]
        }
        if(avp.avpCode == [UMDiameterAvpLMSI avpCode])
        {
                UMDiameterAvp *avp2 = [[UMDiameterAvpLMSI alloc]initWithAvp:avp];
            _var_lmsi = avp2;
            [knownAVPs addObject:avp2]
        }
        ...
        if(avp.avpCode == [UMDiameterAvpMWD_Status avpCode])
        {
                UMDiameterAvp *avp2 = [[UMDiameterAvpMWD_Status alloc]initWithAvp:avp];
            _var_mwd_status = avp2;
            [knownAVPs addObject:avp2]
        }
        if(avp.avpCode == [UMDiameterAvpMME_Absent_User_Diagnostic_SM avpCode])
        {
                UMDiameterAvp *avp2 = [[UMDiameterAvpMME_Absent_User_Diagnostic_SM alloc]initWithAvp:avp];
            _var_mme_absent_user_diagnostic_sm = avp2;
            [knownAVPs addObject:avp2]
        }
        if(avp.avpCode == [UMDiameterAvpMSC_Absent_User_Diagnostic_SM avpCode])
        {
                UMDiameterAvp *avp2 = [[UMDiameterAvpMSC_Absent_User_Diagnostic_SM alloc]initWithAvp:avp];
            _var_msc_absent_user_diagnostic_sm = avp2;
            [knownAVPs addObject:avp2]
        }
        if(avp.avpCode == [UMDiameterAvpSGSN_Absent_User_Diagnostic_SM avpCode])
        {
                UMDiameterAvp *avp2 = [[UMDiameterAvpSGSN_Absent_User_Diagnostic_SM alloc]initWithAvp:avp];
