...
//  ulibdiameter
//
//  Created by afink on 2019-10-13 14:17:04.949000
...
@class UMDiameterAvpDSA_Flags;
@class UMDiameterAvpAVP;
@class UMDiameterAvpFailed_AVP;
@class UMDiameterAvpProxy_Info;
@class UMDiameterAvpRoute_Record;
@interface UMDiameterPacketDelete_Subscriber_Data_Answer : UMDiameterPacket
{
	...
	UMDiameterAvpDSA_Flags	*_var_dsa_flags;
...
@property(readwrite,strong,atomic)	UMDiameterAvpDSA_Flags	*var_dsa_flags;
