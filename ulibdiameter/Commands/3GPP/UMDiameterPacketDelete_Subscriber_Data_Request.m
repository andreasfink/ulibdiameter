...
//  ulibdiameter
//
//  Created by afink on 2021-03-23 23:12:20.499426
//  Copyright © 2019 Andreas Fink. All rights reserved.
//


#import <ulibdiameter/UMDiameterPacketDelete_Subscriber_Data_Request.h>
...
- (void)afterDecode
{
    ...
    for(UMDiameterAvp *avp in _packet_avps)
    {
        ...
        else if(avp.avpCode == [UMDiameterAvpDSR_Flags avpCode])
        {
            UMDiameterAvpDSR_Flags *avp2 = [[UMDiameterAvpDSR_Flags alloc]initWithAvp:avp];
            _var_dsr_flags = avp2;
        }
        else if(avp.avpCode == [UMDiameterAvpSCEF_ID avpCode])
        {
            UMDiameterAvpSCEF_ID *avp2 = [[UMDiameterAvpSCEF_ID alloc]initWithAvp:avp];
            _var_scef_id = avp2;
        }
        ...
        {
            UMDiameterAvpTrace_Reference *avp2 = [[UMDiameterAvpTrace_Reference alloc]initWithAvp:avp];
