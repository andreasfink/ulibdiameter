//
//  UMDiameterPacketAlert_Service_Centre_Answer.m
//  ulibdiameter
//
//  Created by afink on 2021-03-22 08:41:00.472128
...
+ (NSString *)webJsonDefintion
{
    ...
    commandDef[@"command-name"] = @"Alert-Service-Centre-Answer";
    commandDef[@"web-name"] = @"alert-service-centre-answer";
