...
//  ulibdiameter
//
//  Created by afink on 2021-03-22 08:40:59.519770
...
- (void)afterDecode
{
    for(UMDiameterAvp *avp in _packet_avps)
    {
        ...
        if(avp.avpCode == [UMDiameterAvpError_Diagnostic avpCode])
        {
                UMDiameterAvp *avp2 = [[UMDiameterAvpError_Diagnostic alloc]initWithAvp:avp];
        ...
        if(avp.avpCode == [UMDiameterAvpULA_Flags avpCode])
        {
                UMDiameterAvp *avp2 = [[UMDiameterAvpULA_Flags alloc]initWithAvp:avp];
            _var_ula_flags = avp2;
            [knownAVPs addObject:avp2]
        }
        if(avp.avpCode == [UMDiameterAvpSubscription_Data avpCode])
        {
                UMDiameterAvp *avp2 = [[UMDiameterAvpSubscription_Data alloc]initWithAvp:avp];
            _var_subscription_data = avp2;
            [knownAVPs addObject:avp2]
        }
        if(avp.avpCode == [UMDiameterAvpReset_ID avpCode])
        {
                UMDiameterAvp *avp2 = [[UMDiameterAvpReset_ID alloc]initWithAvp:avp];
