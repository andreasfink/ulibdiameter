...
//  ulibdiameter
//
//  Created by afink on 2019-07-10 00:07:33.019000
...
+ (void)webDiameterParameters:(NSMutableString *)s
{
    ...
    [s appendString:@"<tr>\n"];
    [s appendString:@"    <td class=optional>error-diagnostic</td>\n"];
    [s appendString:@"    <td class=optional><input name=\"error-diagnostic\" type=text> </td>\n"];
    [s appendString:@"</tr>\n"];
    ...
    [s appendString:@"<tr>\n"];
    [s appendString:@"    <td class=optional>oc-olr</td>\n"];
    [s appendString:@"    <td class=optional><input name=\"oc-olr\" type=text> </td>\n"];
    [s appendString:@"</tr>\n"];

    [s appendString:@"<tr>\n"];
    [s appendString:@"    <td class=optional>load</td>\n"];
    [s appendString:@"    <td class=optional><input name=\"load\" type=text> </td>\n"];
    [s appendString:@"</tr>\n"];
    ...
    [s appendString:@"<tr>\n"];
    [s appendString:@"    <td class=optional>ula-flags</td>\n"];
    [s appendString:@"    <td class=optional><input name=\"ula-flags\" type=text> </td>\n"];
    [s appendString:@"</tr>\n"];

    [s appendString:@"<tr>\n"];
    [s appendString:@"    <td class=optional>subscription-data</td>\n"];
    [s appendString:@"    <td class=optional><input name=\"subscription-data\" type=text> </td>\n"];
    [s appendString:@"</tr>\n"];

    [s appendString:@"<tr>\n"];
    [s appendString:@"    <td class=optional>reset-id</td>\n"];
    [s appendString:@"    <td class=optional><input name=\"reset-id\" type=text> </td>\n"];
    [s appendString:@"</tr>\n"];
