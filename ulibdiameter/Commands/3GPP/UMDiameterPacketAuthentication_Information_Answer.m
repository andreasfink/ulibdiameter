...
//  ulibdiameter
//
//  Created by afink on 2019-07-02 10:59:07.122000
...
- (void)beforeEncode
{
    ...
    if(_varauthentication_info)
    {
        [arr addObject:_varauthentication_info];
    }
    if(_varue_usage_type)
    {
        [arr addObject:_varue_usage_type];
    }
    if(_varavp.count > 0)
    {
