...
//  ulibdiameter
//
//  Created by afink on 2021-03-22 08:40:59.454514
...
- (void)afterDecode
{
    for(UMDiameterAvp *avp in _packet_avps)
    {
        ...
        if(avp.avpCode == [UMDiameterAvpAuthentication_Info avpCode])
        {
                UMDiameterAvp *avp2 = [[UMDiameterAvpAuthentication_Info alloc]initWithAvp:avp];
            _var_authentication_info = avp2;
            [knownAVPs addObject:avp2]
        }
        if(avp.avpCode == [UMDiameterAvpUE_Usage_Type avpCode])
        {
                UMDiameterAvp *avp2 = [[UMDiameterAvpUE_Usage_Type alloc]initWithAvp:avp];
            _var_ue_usage_type = avp2;
            [knownAVPs addObject:avp2]
        }
