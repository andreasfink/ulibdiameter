...
+ (void)webDiameterParameters:(NSMutableString *)s
{
    ...
    [s appendString:@"<tr>\n"];
    [s appendString:@"    <td class=optional>authentication-info</td>\n"];
    [s appendString:@"    <td class=optional><input name=\"authentication-info\" type=text> </td>\n"];
    [s appendString:@"</tr>\n"];

    [s appendString:@"<tr>\n"];
    [s appendString:@"    <td class=optional>ue-usage-type</td>\n"];
    [s appendString:@"    <td class=optional><input name=\"ue-usage-type\" type=text> </td>\n"];
    [s appendString:@"</tr>\n"];
