...
//  ulibdiameter
//
//  Created by afink on 2021-03-22 08:41:00.340224
...
- (void)afterDecode
{
    for(UMDiameterAvp *avp in _packet_avps)
    {
        ...
        if(avp.avpCode == [UMDiameterAvpUser_Data avpCode])
        {
                UMDiameterAvp *avp2 = [[UMDiameterAvpUser_Data alloc]initWithAvp:avp];
            _var_user_data = avp2;
            [knownAVPs addObject:avp2]
        }
