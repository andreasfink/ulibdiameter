...
+ (void)webDiameterParameters:(NSMutableString *)s
{
    ...
    [s appendString:@"<tr>\n"];
    [s appendString:@"    <td class=optional>user-id</td>\n"];
    [s appendString:@"    <td class=optional><input name=\"user-id\" type=text> </td>\n"];
    [s appendString:@"</tr>\n"];
    ...
    [s appendString:@"<tr>\n"];
    [s appendString:@"    <td class=optional>subscription-data-deletion</td>\n"];
    [s appendString:@"    <td class=optional><input name=\"subscription-data-deletion\" type=text> </td>\n"];
    [s appendString:@"</tr>\n"];
