...
//  ulibdiameter
//
//  Created by afink on 2021-03-22 09:25:10.828223
...
- (void)afterDecode
{
    for(UMDiameterAvp *avp in _packet_avps)
    {
        ...
        else if(avp.avpCode == [UMDiameterAvpSubscription_Data_Deletion avpCode])
        {
            UMDiameterAvpSubscription_Data_Deletion *avp2 = [[UMDiameterAvpSubscription_Data_Deletion alloc]initWithAvp:avp];
