...
- (void)afterDecode
{
    for(UMDiameterAvp *avp in _packet_avps)
    {
        ...
        else if([avp isKindOfClass:[UMDiameterAvpSC_Address class]])
        {
        ...
        {
            _var_smsmi_correlation_id = (UMDiameterAvpSMSMI_Correlation_ID *)avp;
        }
        ...
        else if([avp isKindOfClass:[UMDiameterAvpSMS_GMSC_Alert_Event class]])
        {
            _var_sms_gmsc_alert_event = (UMDiameterAvpSMS_GMSC_Alert_Event *)avp;
        }
