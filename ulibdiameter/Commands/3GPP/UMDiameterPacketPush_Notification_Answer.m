...
//  ulibdiameter
//
//  Created by afink on 2021-03-22 08:41:00.272775
...
@implementation UMDiameterPacketPush_Notification_Answer
...
+ (NSString *)webJsonDefintion
{
    ...
    commandDef[@"command-name"] = @"Push-Notification-Answer";
    commandDef[@"web-name"] = @"push-notification-answer";
