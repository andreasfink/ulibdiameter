...
//  ulibdiameter
//
//  Created by afink on 2019-10-16 20:49:11.204000
...
- (void)beforeEncode
{
    ...
    {
        [_var_requested_eutran_authentication_info beforeEncode];
        [arr addObject:_var_requested_eutran_authentication_info];
    }
    if(_var_requested_utran_geran_authentication_info)
    {
        [_var_requested_utran_geran_authentication_info beforeEncode];
...
- (void)afterDecode
{
    for(UMDiameterAvp *avp in _packet_avps)
    {
        ...
        else if([avp isKindOfClass:[UMDiameterAvpRequested_EUTRAN_Authentication_Info class]])
        {
            _var_requested_eutran_authentication_info = (UMDiameterAvpRequested_EUTRAN_Authentication_Info *)avp;
        }
        else if([avp isKindOfClass:[UMDiameterAvpRequested_UTRAN_GERAN_Authentication_Info class]])
        {
            _var_requested_utran_geran_authentication_info = (UMDiameterAvpRequested_UTRAN_GERAN_Authentication_Info *)avp;
        }
        else if([avp isKindOfClass:[UMDiameterAvpVisited_PLMN_Id class]])
        {
            _var_visited_plmn_id = (UMDiameterAvpVisited_PLMN_Id *)avp;
        }
        else if([avp isKindOfClass:[UMDiameterAvpAIR_Flags class]])
        {
            _var_air_flags = (UMDiameterAvpAIR_Flags *)avp;
        }
...
+ (NSString *)webJsonDefintion
{
    ...
    [arr addObject:@{ @"_var_requested_eutran_authentication_info" : [UMDiameterAvpRequested_EUTRAN_Authentication_Info definition] }];
    [arr addObject:@{ @"_var_requested_utran_geran_authentication_info" : [UMDiameterAvpRequested_UTRAN_GERAN_Authentication_Info definition] }];
    [arr addObject:@{ @"_var_visited_plmn_id" : [UMDiameterAvpVisited_PLMN_Id definition] }];
    [arr addObject:@{ @"_var_air_flags" : [UMDiameterAvpAIR_Flags definition] }];
    ...
    commandDef[@"web-name"] = @"authentication-information-request";
