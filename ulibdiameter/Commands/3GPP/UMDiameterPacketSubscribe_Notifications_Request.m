...
//  ulibdiameter
//
//  Created by afink on 2019-10-16 21:32:34.228000
...
+ (NSString *)webJsonDefintion
{
    ...
    [arr addObject: [UMDiameterAvpSend_Data_Indication definition]];
    [arr addObject: [UMDiameterAvpServer_Name definition]];
    [arr addObject: [UMDiameterAvpSubs_Req_Type definition]];
    [arr addObject: [UMDiameterAvpData_Reference definition]];
    [arr addObject: [UMDiameterAvpIdentity_Set definition]];
    [arr addObject: [UMDiameterAvpExpiry_Time definition]];
