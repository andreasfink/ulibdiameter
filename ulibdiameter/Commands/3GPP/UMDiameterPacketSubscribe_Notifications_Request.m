...
//  ulibdiameter
//
//  Created by afink on 2019-10-16 20:49:11.807000
...
- (void)afterDecode
{
    for(UMDiameterAvp *avp in _packet_avps)
    {
        ...
        else if([avp isKindOfClass:[UMDiameterAvpSend_Data_Indication class]])
        {
            _var_send_data_indication = (UMDiameterAvpSend_Data_Indication *)avp;
        }
        else if([avp isKindOfClass:[UMDiameterAvpServer_Name class]])
        {
            _var_server_name = (UMDiameterAvpServer_Name *)avp;
        }
        else if([avp isKindOfClass:[UMDiameterAvpSubs_Req_Type class]])
        {
            _var_subs_req_type = (UMDiameterAvpSubs_Req_Type *)avp;
        }
...
+ (NSString *)webJsonDefintion
{
    ...
    [arr addObject:@{ @"_var_send_data_indication" : [UMDiameterAvpSend_Data_Indication definition] }];
    [arr addObject:@{ @"_var_server_name" : [UMDiameterAvpServer_Name definition] }];
    [arr addObject:@{ @"_var_subs_req_type" : [UMDiameterAvpSubs_Req_Type definition] }];
    ...
    [arr addObject:@{ @"_var_expiry_time" : [UMDiameterAvpExpiry_Time definition] }];
