...
//  ulibdiameter
//
//  Created by afink on 2021-03-22 08:40:59.619250
...
- (void)afterDecode
{
    for(UMDiameterAvp *avp in _packet_avps)
    {
        ...
        if(avp.avpCode == [UMDiameterAvpVPLMN_CSG_Subscription_Data avpCode])
        {
                UMDiameterAvp *avp2 = [[UMDiameterAvpVPLMN_CSG_Subscription_Data alloc]initWithAvp:avp];
        ...
        if(avp.avpCode == [UMDiameterAvpIDR_Flags avpCode])
        {
                UMDiameterAvp *avp2 = [[UMDiameterAvpIDR_Flags alloc]initWithAvp:avp];
            _var_idr_flags = avp2;
            [knownAVPs addObject:avp2]
        }
